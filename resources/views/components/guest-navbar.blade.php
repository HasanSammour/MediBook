    ...
    <div class="container">
        ...
        <div class="nav-menu">
            <ul class="nav-links">
                ...
                <li><a href="{{ route('hospitals') }}" class="{{ request()->routeIs('hospitals') ? 'active' : '' }}">Hospitals</a></li>
                <li><a href="{{ route('doctors') }}" class="{{ request()->routeIs('doctors') ? 'active' : '' }}">Doctors</a></li>
